...
class CommentServiceTest(
    ...
    given("댓글 수정시") {
        ...
        val saved = commentRepository.save(Comment("댓글 내용", post, "수정된 댓글 생성자"))
        When("인풋이 정상적으로 들어오면") {
            ...
            then("정상 수정됨을 확인한다.") {
                ...
                updated?.updatedBy shouldBe "수정된 댓글 생성자"
            }
        }
        When("작성자와 수정자가 다르면") {
    ...
    given("댓글 삭제시") {
        ...
        val saved1 = commentRepository.save(Comment("댓글 내용", post, "댓글 생성자1"))
